...
class DockerProcessExecutorProgressTest {
    ...
    @Test
    void buildRunAllScript_throttlesNormalProgressByTestcaseCountAndSupportsForceProgress() {
        ...
        assertThat(script).contains("[ \"$completed\" -eq 1 ]");
        assertThat(script).contains("[ \"$((completed % 5))\" -eq 0 ]");
        ...
        assertThat(script).doesNotContain("last_progress_written_at_ms");
        assertThat(script).doesNotContain("[ $((now - last_progress_written_at_ms)) -ge 500 ]");
    }
