...
import com.example.ssoj.judge.presentation.RunnerExecutionExceptionHandler;
...
class RunnerExecutionControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders
                ...
                .setControllerAdvice(new RunnerExecutionExceptionHandler())
                .build();
    }
    ...
    @Test
    void execute_returnsTooManyRequestsWhenRunnerIsBusy() throws Exception {
        RunnerExecutionRequest request = new RunnerExecutionRequest(
                123L,
                456L,
                "python",
        ...
        when(runnerExecutionService.executeSubmission(request))
                .thenThrow(new RunnerBusyException("Runner is busy. Please retry later."));
